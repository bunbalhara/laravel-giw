...
<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-light ">
    ...
    <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-light m-aside-menu--submenu-skin-light position-static" m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500">
        <ul class="m-menu__nav ">
            ...
            <li class="m-menu__item  {{ Request::is('account/blog*') ? 'm-menu__item--open' : '' }} m-menu__item--submenu" aria-haspopup="true" m-menu-submenu-toggle="hover">
                ...
                <div class="m-menu__submenu ">
                    ...
                    <ul class="m-menu__subnav">
                        <li class="m-menu__item {{ Request::is('account/domainList*') ? 'm-menu__item--active' : '' }}" aria-haspopup="true">
                            <a href="" class="m-menu__link ">
                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                    <span></span>
                                </i>
                                <span class="m-menu__link-text">My Blog</span>
                            </a>
                        </li>
                    </ul>
                </div>
