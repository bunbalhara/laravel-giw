            ...
            <form method="POST" action="{{ route('register') }}" id="auth_form">
                ...
                <div class="field-wrap">
                    <p class="mb-0 text-left">
                        Name:<i class="fa fa-info-circle tooltip_1" title="Valid Email Address."></i>
                    </p>
                ...
                <div class="field-wrap" x-data={show:false}>
                    <p class="mb-0 text-left">Password <i class="fa fa-info-circle tooltip_1" title="Minimum characters:8."></i></p>
                ...
                <div>
                    <div class="mt-4">
                        By proceeding, you agree to <a href="/legal/terms-and-conditions" class="link_to underline" target="_blank">Terms of Service & Privacy Policy</a>
                    </div>
